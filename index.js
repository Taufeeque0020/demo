async function saveToCrud(event) {
    ...
    try{
    const response= await axios.post("https://crudcrud.com/api/882d06f82fd241a9accf2fedaa8dcf01/Expense",obj)
...
window.addEventListener("DOMContentLoaded",()=>{
   async function reload(){
     try{
        const response = await axios.get("https://crudcrud.com/api/882d06f82fd241a9accf2fedaa8dcf01/Expense")
...
async function deleteExpense(id) {
    try{
        const response = await axios.delete(`https://crudcrud.com/api/882d06f82fd241a9accf2fedaa8dcf01/Expense/${id}`)
        console.log(response)
